	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->CircustanciasMedica->save($this->request->data)) {
				$this->Flash->success(__('The circustancias medica has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Flash->error(__('The circustancias medica could not be saved. Please, try again.'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->CircustanciasMedica->delete()) {
			$this->Flash->success(__('The circustancias medica has been deleted.'));
		} else {
			$this->Flash->error(__('The circustancias medica could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
}
