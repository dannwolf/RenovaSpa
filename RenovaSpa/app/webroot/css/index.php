...
<html>
	...
	<div class="row">
		...
		<div class="col-8">
			<form >
				<input type="text" size="90" placeholder="Nombre: "/>
				<input type="number" size="30" placeholder="Edad: "/>
				<br>
				<br>
				<input type="text" size="55" placeholder="País: "/>
				<input type="text" size="55" placeholder="E-mail: "/>
				<br>
				<br>
				<input type="text" size="90" placeholder="Hotel: "/>
				<input type="number" size="30" placeholder="Habitación: "/>
				<br>
				<br>
				<input type="text" size="115" placeholder="Agencia de viajes: "/>
				<br>
				<br>
				<input type="text" size="55" placeholder="Tratamiento: "/>
				<input type="text" size="55" placeholder="Terapeuta: "/>
				<br>
				<br>
			</form>
		</div>
