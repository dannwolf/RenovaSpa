...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Circustancias Medica'), array('action' => 'delete', $circustanciasMedica['CircustanciasMedica']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $circustanciasMedica['CircustanciasMedica']['id']))); ?> </li>
